...
var Button = React.createClass({
	...
	localAddToProgressFn: function localAddToProgressFn(e) {
	...
	render: function render() {
		...
		return React.createElement(
			'button',
			{ onClick: this.localAddToProgressFn, style: buttonStyle },
			' ',
			name,
			' '
		);
...
var DropDownList = React.createClass({
	...
	render: function render() {
		...
		return React.createElement(
			'select',
			{ onChange: this.props.listChangedFn },
			React.createElement(
				'option',
				{ value: 'progressBar1' },
				'Progress 1 '
...
var Container = React.createClass({
	...
	listChanged: function listChanged(e) {
	...
	render: function render() {
		...
		return React.createElement(
			'div',
			{ className: 'col-md-4 col-sm-8 col-xs-10', style: containerStyle },
			React.createElement(
				'h2',
				{ style: headerStyle },
				' Progress Bars Demo '
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-md-4 col-sm-12 col-xs-10 text-center', style: vAlignStyle },
						React.createElement(DropDownList, { id: 'list1', listChangedFn: this.listChanged })
					),
					React.createElement(
						'div',
						{ className: 'col-md-2 col-sm-3 col-xs-6 text-center', style: vAlignStyle },
