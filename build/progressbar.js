...
var ProgressBar = React.createClass({displayName: "ProgressBar",
	...
	render: function(){
		...
		return (
		  React.createElement("div", {style: outerDivStyle}, 
		  	React.createElement("span", {style: labelStyle}, 
				this.barWidthText, "%"
			), 
		  	React.createElement("div", {style: progressBarStyle}
		  	)
		  )
		);
	}
...
var Button = React.createClass({displayName: "Button",
	...
	render: function(){
		...
		return ( React.createElement("button", {onClick: this.localAddToProgressFn, style: buttonStyle}, " ", name, " ") )
	}
});
...
var DropDownList = React.createClass({displayName: "DropDownList",
	...
	render: function(){
		...
		return (
			React.createElement("select", {onChange: this.props.listChangedFn}, 
				React.createElement("option", {value: "progressBar1"}, "Progress 1 "), 
				React.createElement("option", {value: "progressBar2"}, "Progress 2 "), 
				React.createElement("option", {value: "progressBar3"}, "Progress 3 ")
			)
		      );
	}
...
var Container = React.createClass({displayName: "Container",
	...
	render : function(){
		...
		return (
			React.createElement("div", {className: "col-md-4 col-sm-8 col-xs-10", style: containerStyle}, 
			   React.createElement("h2", {style: headerStyle}, " Progress Bars Demo "), 
			   React.createElement("br", null), 
			   React.createElement("div", {className: "row"}, 
				   React.createElement("div", {className: "col-md-12 col-sm-12 col-xs-12"}, 
					   React.createElement(ProgressBar, {id: "progressBar1", progressValue: this.state.buttonIncrementValue, activeProgressBar: this.state.activeProgressBarId}), 
					   React.createElement("br", null), 
					   React.createElement(ProgressBar, {id: "progressBar2", progressValue: this.state.buttonIncrementValue, activeProgressBar: this.state.activeProgressBarId}), 
					   React.createElement("br", null), 
					   React.createElement(ProgressBar, {id: "progressBar3", progressValue: this.state.buttonIncrementValue, activeProgressBar: this.state.activeProgressBarId}), 
					   React.createElement("br", null)
				  )
			   ), 
			   React.createElement("div", {className: "row"}, 
			   	React.createElement("div", {className: "col-md-10 text-center"}, 
					React.createElement("div", {className: "col-md-4 col-sm-12 col-xs-10 text-center", style: vAlignStyle}, 
						React.createElement(DropDownList, {id: "list1", listChangedFn: this.listChanged})
					), 

					React.createElement("div", {className: "col-md-2 col-sm-3 col-xs-6 text-center", style: vAlignStyle}, 
						React.createElement(Button, {id: "button1", addToProgressFn: this.addToProgress, buttonValue: -25, buttonName: "-25"})
					), 

					React.createElement("div", {className: "col-md-2 col-sm-3 col-xs-6 text-center", style: vAlignStyle}, 
						React.createElement(Button, {id: "button2", addToProgressFn: this.addToProgress, buttonValue: -10, buttonName: "-10"})
					), 

					React.createElement("div", {className: "col-md-2 col-sm-3 col-xs-6 text-center", style: vAlignStyle}, 
						React.createElement(Button, {id: "button3", addToProgressFn: this.addToProgress, buttonValue: +10, buttonName: "+10"})
					), 

					React.createElement("div", {className: "col-md-2 col-sm-3 col-xs-6 text-center", style: vAlignStyle}, 
						React.createElement(Button, {id: "button4", addToProgressFn: this.addToProgress, buttonValue: +25, buttonName: "+25"})
					)
				)
			   )
			)
...
ReactDOM.render(React.createElement(Container, null),document.getElementById("react-root"));
